...
function SelectItem({
	...
	return (
		...
		// 	{caretPosition === "right" && (
		// 		<span className="absolute flex size-3.5 items-center ml-auto justify-end">
		// 			<SelectPrimitive.ItemIndicator>
		// 				<CheckIcon size={16} />
		// 			</SelectPrimitive.ItemIndicator>
		// 		</span>
		...
		<SelectPrimitive.Item
			data-slot="select-item"
			className={cn(
				"focus:bg-accent focus:text-accent-foreground relative flex w-full cursor-default items-center rounded py-1.5 text-sm outline-hidden select-none data-disabled:pointer-events-none data-disabled:opacity-50",
				icon === "left" && "ps-8 pe-2",
				icon === "right" && "px-2.5",
				className,
			)}
			...
			{icon === "right" && (
				<span className="flex size-3.5 items-center ml-auto justify-end">
					<SelectPrimitive.ItemIndicator>
						<CheckIcon size={16} />
					</SelectPrimitive.ItemIndicator>
				</span>
